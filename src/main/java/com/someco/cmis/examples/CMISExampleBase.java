...
public class CMISExampleBase extends ExampleBase {
	private String serviceUrl = "http://192.168.1.51:9091/alfresco/cmisatom"; // Uncomment for Atom Pub binding
	...
	public Folder createTestFolder(String nameFolder, String typeFolder) {
		Session session = getSession();
		...
		properties.put(PropertyIds.OBJECT_TYPE_ID, typeFolder);
